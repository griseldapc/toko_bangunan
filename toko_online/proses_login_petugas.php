...
if($_POST){
    ...
    if(empty($id_petugas)){
        echo "<script>alert('id petugas tidak boleh kosong');location.href='login_petugas.php';</script>";
        ...
        echo "<script>alert('level tidak boleh kosong');location.href='login_petugas.php';</script>";
    } else {
